...
If you don't know how to answer a question, use the available tools to look up relevant information. You should particularly do this for questions about IKEA.`;
...
export async function POST(req: NextRequest) {
  try {
    ...
    const tool = createRetrieverTool(retriever, {
      ...
      description: "Searches and returns up-to-date information about IKEA.",
    });

    const tools = [new TavilySearchResults({ maxResults: 1 }), tool];
